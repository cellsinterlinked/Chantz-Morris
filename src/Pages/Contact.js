...
const Contact = props => {
  ...
  const [fullPhone, setFullPhone] = useState("")
    ...
    const submitHandler = (event) => {
      ...
      try {
      sendRequest('http://localhost:5000/api/messages', 'POST', JSON.stringify({
        fName: fName,
        lName: lName,
        email: email,
        phone: phone,
...
24/7!
        ...
        <div className="contactName__Container">
          ...
          <div className="contactName__smallBox">
            <div className="fname__Form">
              <input type="text" id="fname" name="fname" onChange={fNameController} value={message.firstName}></input>
              <label htmlFor="fname">First Name</label>
            </div>
            <div className="lname__Form">
              <input type="text" id="lname" name="lname" onChange={lNameController} value={message.lastName}></input>
          ...
          <div className="emailContainer">
            <div>
              <p>Email *</p>
              <input type="text" id="email" name="email" onChange={emailController} value={message.email}></input>
            </div>
          </div>
        </div>
        <div className="contactFormPhone__Container">
          ...
          <div className="phone-boxes__Container">
            <div className="phoneFormBox">
              <input type="number" id="fnumber" name="fnumber" onChange={oneController} value={message.phone1}></input>
              <label htmlFor="fnumber">###</label>
            </div>
            <div className="phoneFormBox">
              <input type="number" id="snumber" name="snumber" onChange={twoController} value={message.phone2}></input>
              <label htmlFor="snumber">###</label>
            </div>
            <div className="phoneFormBox">
              <input type="number" id="tnumber" name="tnumber" onChange={threeController} value={message.phone3}></input>
        ...
        <textarea id="message" name="message" onChange={commentController} value={message.comment}></textarea>
        </div>
